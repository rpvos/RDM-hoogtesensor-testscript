...
from GolfhoogteSensor.daqhats import HatError, HatIDs, OptionFlags, mcc118
from GolfhoogteSensor.daqhats.daqhats_utils import (
    chan_list_to_mask,
    enum_mask_to_string,
    select_hat_device,
)
...
def read_and_display_data(hat, num_channels):
    ...
    while True:
        ...
        print(
            "\r{:12}".format(samples_read_per_channel),
            " {:12} ".format(total_samples_read),
            end="",
        )
